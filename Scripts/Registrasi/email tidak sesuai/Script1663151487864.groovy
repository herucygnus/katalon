...
WebUI.setText(findTestObject('Page_Daftar Sebagai Pemberi Dana  ALAMI Peer-to-Peer Lending Syariah/input_Email'), 'heru.cygnus@gmail.')
...
WebUI.verifyElementVisible(findTestObject('Page_Daftar Sebagai Pemberi Dana  ALAMI Peer-to-Peer Lending Syariah/label_silakan isi email dengan format yang benar'))
