...
WebUI.verifyElementVisible(findTestObject('Page_Daftar Sebagai Pemberi Dana  ALAMI Peer-to-Peer Lending Syariah/tahap_2'))

WebUI.verifyElementVisible(findTestObject('Page_Daftar Sebagai Pemberi Dana  ALAMI Peer-to-Peer Lending Syariah/label_Kebijakan Privasi  Ketentuan Pengguna'))

WebUI.verifyElementNotChecked(findTestObject('Page_Daftar Sebagai Pemberi Dana  ALAMI Peer-to-Peer Lending Syariah/input_Saya sudah membaca dan setuju dengan_setujuKebijakan'), 
    0)
