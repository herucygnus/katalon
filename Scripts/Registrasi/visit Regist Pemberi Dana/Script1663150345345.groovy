...
WebUI.verifyElementVisible(findTestObject('Page_Daftar Sebagai Pemberi Dana/label_Registrasi Pemberi Dana'))

WebUI.verifyElementVisible(findTestObject('Page_Daftar Sebagai Pemberi Dana/form_regist'))
